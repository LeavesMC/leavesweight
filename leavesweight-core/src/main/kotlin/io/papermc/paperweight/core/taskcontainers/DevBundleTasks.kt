...
import io.papermc.paperweight.core.taskcontainers.LeavesclipTasks.Companion.registerVersionArtifact
...
class DevBundleTasks(
    ...
    val paperclipForDevBundle by tasks.registering<CreateLeavesclipJar> {
